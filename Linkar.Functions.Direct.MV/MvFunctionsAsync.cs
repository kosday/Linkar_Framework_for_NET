...
namespace Linkar.Functions.Direct
{
    public partial class MvFunctions
    {
        ...
        public static Task<string> ReadAsync(CredentialOptions credentialsOptions, string filename, string recordIds, string dictionaries = "", ReadOptions readOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return Read(credentialsOptions, filename, recordIds, dictionaries, readOptions, customVars, receiveTimeout);
            });
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return Update(credentialsOptions, filename, records, updateOptions, customVars, receiveTimeout);
            });
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return New(credentialsOptions, filename, records, newOptions, customVars, receiveTimeout);
            });
        ...
        string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return Select(credentialsOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, customVars, receiveTimeout);
            });
        ...
        /// <param name="receiveTimeout">It's the maximum time in seconds that the client will keep waiting the answer by the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public static Task<string> ConversionAsync(CredentialOptions credentialsOptions, CONVERSION_TYPE conversionOptions, string expression, string code,
                string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return Conversion(credentialsOptions, conversionOptions, expression, code, customVars, receiveTimeout);
            });
        ...
        /// <param name="receiveTimeout">It's the maximum time in seconds that the client will keep waiting the answer by the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public static Task<string> LkSchemaAsync(CredentialOptions credentialsOptions, LkSchemasOptions lkSchemasOptions = null,
             string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
