...
namespace Linkar.Functions.Direct.MV
{
    public static partial class Functions
    {
        ...
        ///                 CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
        /// 
        ///                 result = Functions.UpdatePartialAsync(credentials, "LK.CUSTOMERS", "2" + ASCII_Chars.FS_chr + "CUSTOMER UPDATE 2" + ASCII_Chars.FS_chr + "", "NAME").Result;
        ///             }
        ///             catch (Exception ex)
        ///             {
        ///                 string error = ex.Message;
        ...
        /// The record will have to be read, modified and saved again.
        /// </remarks>
        public static Task<string> UpdatePartialAsync(CredentialOptions credentialOptions, string filename, string records, string dictionaries, UpdateOptions updateOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return UpdatePartial(credentialOptions, filename, records, dictionaries, updateOptions, customVars, receiveTimeout);
            });
