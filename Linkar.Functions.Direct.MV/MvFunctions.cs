...
namespace Linkar.Functions.Direct
{
    ...
    public partial class MvFunctions
    {
        ...
        {
            return DirectFunctions.Read(credentialsOptions, filename, recordIds, dictionaries, readOptions, DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Update(CredentialOptions credentialsOptions, string filename, string records, UpdateOptions updateOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Update(credentialsOptions, filename, records, updateOptions, DATAFORMAT_TYPE.MV, DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string New(CredentialOptions credentialsOptions, string filename, string records, NewOptions newOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.New(credentialsOptions, filename, records, newOptions, DATAFORMAT_TYPE.MV, DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Delete(CredentialOptions credentialsOptions, string filename, string records, DeleteOptions deleteOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Delete(credentialsOptions, filename, records, deleteOptions, DATAFORMAT_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Select(CredentialOptions credentialsOptions, string filename, string selectClause = "", string sortClause = "", string dictClause = "", string preSelectClause = "", SelectOptions selectOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Select(credentialsOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, DATAFORMATCRU_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Subroutine(CredentialOptions credentialsOptions, string subroutineName, int argsNumber, string arguments,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Subroutine(credentialsOptions, subroutineName, argsNumber, arguments, DATAFORMAT_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Conversion(CredentialOptions credentialsOptions, CONVERSION_TYPE conversionOptions, string expression, string code,
                string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Conversion(credentialsOptions, expression, code, conversionOptions, DATAFORMAT_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Format(CredentialOptions credentialsOptions, string expression, string formatSpec,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Format(credentialsOptions, expression, formatSpec, DATAFORMAT_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Dictionaries(CredentialOptions credentialsOptions, string filename,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Dictionaries(credentialsOptions, filename, DATAFORMAT_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string Execute(CredentialOptions credentialsOptions, string statement,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Execute(credentialsOptions, statement, DATAFORMAT_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.GetVersion(credentialsOptions, DATAFORMAT_TYPE.MV, receiveTimeout);
        }
        ...
        public static string LkSchemas(CredentialOptions credentialsOptions, LkSchemasOptions lkSchemasOptions = null,
             string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.LkSchemas(credentialsOptions, lkSchemasOptions, DATAFORMATSCH_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        public static string LkProperties(CredentialOptions credentialsOptions, string filename, LkPropertiesOptions lkPropertiesOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.LkProperties(credentialsOptions, filename, lkPropertiesOptions, DATAFORMATSCH_TYPE.MV, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.ResetCommonBlocks(credentialsOptions, DATAFORMAT_TYPE.MV, receiveTimeout);
        }
    }
