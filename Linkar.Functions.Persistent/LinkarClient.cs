namespace Linkar.Functions.Persistent
{
    ...
    public class LinkarClient
    {
        ...
        /// </para>
        /// </remarks>
        public string LkProperties(string filename, LkPropertiesOptions lkPropertiesOptions = null, DATAFORMATSCHPROP_TYPE outputFormat = DATAFORMATSCHPROP_TYPE.MV, string customVars = "", int receiveTimeout = 0)
        {
