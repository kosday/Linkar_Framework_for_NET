namespace Linkar.Functions.Direct
{
    ...
    public partial class JsonFunctions
    {
        ...
        public static string Read(CredentialOptions credentialsOptions, string filename, string records, string dictionaries = "", ReadOptions readOptions = null,
            JSON_FORMAT jsonFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Read(credentialsOptions, filename, records, dictionaries, readOptions, (DATAFORMATCRU_TYPE)jsonFormat, customVars, receiveTimeout);
        }
        ...
        public static string Update(CredentialOptions credentialsOptions, string filename, string records, UpdateOptions updateOptions = null,
            JSON_FORMAT jsonFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Update(credentialsOptions, filename, records, updateOptions,  DATAFORMAT_TYPE.JSON, (DATAFORMATCRU_TYPE)jsonFormat, customVars, receiveTimeout);
        }
        ...
        public static string New(CredentialOptions credentialsOptions, string filename, string records, NewOptions newOptions = null,
            JSON_FORMAT jsonFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.New(credentialsOptions, filename, records, newOptions, DATAFORMAT_TYPE.JSON, (DATAFORMATCRU_TYPE)jsonFormat, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.Delete(credentialsOptions, filename, records, deleteOptions, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        public static string Select(CredentialOptions credentialsOptions, string filename, string selectClause = "", string sortClause = "", string dictClause = "", string preSelectClause = "", SelectOptions selectOptions = null,
            JSON_FORMAT jsonFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Select(credentialsOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, (DATAFORMATCRU_TYPE)jsonFormat, customVars, receiveTimeout);
        }
        ...
        public static string Subroutine(CredentialOptions credentialsOptions, string subroutineName, int argsNumber, string arguments,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Subroutine(credentialsOptions, subroutineName, argsNumber, arguments, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        /// <param name="receiveTimeout">It's the maximum time in seconds that the client will keep waiting the answer by the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public static string Conversion(CredentialOptions credentialsOptions, CONVERSION_TYPE conversionType, string expression, string code,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Conversion(credentialsOptions, expression, code, conversionType, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        public static string Format(CredentialOptions credentialsOptions, string expression, string formatSpec,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Format(credentialsOptions, expression, formatSpec, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        public static string Dictionaries(CredentialOptions credentialsOptions, string filename,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Dictionaries(credentialsOptions, filename, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        public static string Execute(CredentialOptions credentialsOptions, string statement,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Execute(credentialsOptions, statement, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        /// <param name="receiveTimeout">It's the maximum time in seconds that the client will keep waiting the answer by the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public static string GetVersion(CredentialOptions credentialsOptions, int receiveTimeout = 0)
        {
            return DirectFunctions.GetVersion(credentialsOptions, DATAFORMAT_TYPE.JSON, receiveTimeout);
        }
        ...
        public static string LkSchemas(CredentialOptions credentialsOptions, LkSchemasOptions lkSchemasOptions = null,
             string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.LkSchemas(credentialsOptions, lkSchemasOptions, DATAFORMATSCH_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        public static string LkProperties(CredentialOptions credentialsOptions, string filename, LkPropertiesOptions lkPropertiesOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.LkProperties(credentialsOptions, filename, lkPropertiesOptions, DATAFORMATSCH_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.GetTable(credentialsOptions, filename, selectClause, dictClause, sortClause, tableOptions, customVars, receiveTimeout);
        }
        ...
        /// <param name="receiveTimeout">It's the maximum time in seconds that the client will keep waiting the answer by the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public static string ResetCommonBlocks(CredentialOptions credentialsOptions, int receiveTimeout = 0)
        {
            return DirectFunctions.ResetCommonBlocks(credentialsOptions, DATAFORMAT_TYPE.JSON, receiveTimeout);
        }
    }
}
