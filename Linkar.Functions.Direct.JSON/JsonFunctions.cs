namespace Linkar.Functions.Direct.JSON
{
    ...
    public static partial class Functions
    {
        ...
        public static string UpdatePartial(CredentialOptions credentialOptions, string filename, string records, UpdateOptions updateOptions = null,
                    JSON_FORMAT jsonFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.UpdatePartial(credentialOptions, filename, records, "", updateOptions, DATAFORMAT_TYPE.JSON, (DATAFORMATCRU_TYPE)jsonFormat, customVars, receiveTimeout);
        }
