...
namespace Linkar.Functions.Direct.JSON
{
    ...
    public static partial class Functions
    {
        ...
        {
            return DirectFunctions.Delete(credentialOptions, filename, records, deleteOptions, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
        ...
        public static string Conversion(CredentialOptions credentialOptions, CONVERSION_TYPE conversionOptions, string expression, string code,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Conversion(credentialOptions, expression, code, conversionOptions, DATAFORMAT_TYPE.JSON, customVars, receiveTimeout);
        }
