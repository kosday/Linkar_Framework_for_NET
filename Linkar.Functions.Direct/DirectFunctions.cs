...
namespace Linkar.Functions.Direct
{
    ...
    public static class DirectFunctions
    {
        ...
        /// <param name="outputFormat">The format of the result from the Read, New, Update and Select operations: MV, XML, XML_DICT, XML_SCH, JSON, JSON_DICT or JSON_SCH.</param>
            ...
            DATAFORMATCRU_TYPE outputFormat = DATAFORMATCRU_TYPE.MV, string customVars = "", int receiveTimeout = 0)
        {
            ...
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, readArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, updateArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)inputFormat;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, newArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
        ...
        /// <param name="outputFormat">The format of the result from the operation: MV, XML or JSON.</param>
        /// <param name="customVars">Free text sent to the database for custom processing. SUB.LK.MAIN.CONTROL.CUSTOM will be called if this parameter has content.</param>
        /// <param name="receiveTimeout">The maximum time in seconds that the client will wait for a response from the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, deleteArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, selectArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, subroutineArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, conversionArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, formatArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, dictionariesArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, executeArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
        ...
        public static string SendCommand(CredentialOptions credentialOptions, string command, ENVELOPE_FORMAT commandFormat = ENVELOPE_FORMAT.XML, int receiveTimeout = 0)
        {
            ...
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, sendCommandArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
        ...
        public static string GetVersion(CredentialOptions credentialOptions, DATAFORMAT_TYPE outputFormat = DATAFORMAT_TYPE.MV, int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, versionArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
        ...
        /// <param name="outputFormat">The format of the result from the operation: MV, XML, JSON or TABLE.</param>
        /// <param name="customVars">Free text sent to the database for custom processing. SUB.LK.MAIN.CONTROL.CUSTOM will be called if this parameter has content.</param>
        /// <param name="receiveTimeout">The maximum time in seconds that the client will wait for a response from the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
             ...
             string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, lkSchemaArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)outputFormat;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, lkPropertiesArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
            ...
            OperationOptions tableOptions = null, string customVars = "", int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)DATAFORMAT_TYPE.MV;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, getTableArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
        ...
        public static string ResetCommonBlocks(CredentialOptions credentialOptions, DATAFORMAT_TYPE outputFormat, int receiveTimeout = 0)
        {
            ...
            byte byteInputFormat = (byte)DATAFORMAT_TYPE.MV;
            byte byteOutputFormat = (byte)DATAFORMAT_TYPE.MV;
            string result = Linkar.ExecuteDirectOperation(credentialOptions.ToString(), opCode, resetCommonBlocksArgs, byteInputFormat, byteOutputFormat, receiveTimeout);
            return result;
        }
    }
}
