...
namespace Linkar.Functions.Persistent.JSON
{
    public partial class LinkarClient
    {
        ...
        /// <param name="dictionaries">List of dictionaries to read. You may use the format LKFLDx where x is the attribute number.</param>
            ...
            JSON_FORMAT jsonFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return this.UpdatePartial(filename, records, updateOptions, jsonFormat, customVars, receiveTimeout);
            });
        ...
        /// </code>
        /// </example>
        public Task<string> LkPropertiesAsync(string filename, LkPropertiesOptions lkPropertiesOptions = null, JSON_FORMAT outputFormat = JSON_FORMAT.JSON, string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
