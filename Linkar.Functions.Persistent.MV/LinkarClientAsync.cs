...
namespace Linkar.Functions.Persistent.MV
{
    public partial class LinkarClient
    {
        ...
        /// <param name="receiveTimeout">The maximum time in seconds that the client will wait for a response from the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public Task<string> LkSchemasAsync(LkSchemaOptions lkSchemaOptions = null, string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
                return this.LkSchemas(lkSchemaOptions, customVars, receiveTimeout);
            });
        ...
        /// <param name="receiveTimeout">The maximum time in seconds that the client will wait for a response from the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public Task<string> GetTableAsync(string filename, string selectClause = "", string dictClause = "", string sortClause = "", OperationOptions tableOptions = null, string customVars = "", int receiveTimeout = 0)
        {
            var task = new Task<string>(() =>
            {
