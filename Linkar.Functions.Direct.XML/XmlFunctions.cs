namespace Linkar.Functions.Direct
{
    ...
    public static partial class XmlFunctions
    {
        ...
        {
            return DirectFunctions.Read(credentialsOptions, filename, records, dictionaries, readOptions, (DATAFORMATCRU_TYPE)xmlFormat, customVars, receiveTimeout);
        }
        ...
        public static string Update(CredentialOptions credentialsOptions, string filename, string records, UpdateOptions updateOptions = null,
            XML_FORMAT xmlFormat = XML_FORMAT.XML, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Update(credentialsOptions, filename, records, updateOptions, DATAFORMAT_TYPE.XML, (DATAFORMATCRU_TYPE)xmlFormat, customVars, receiveTimeout);
        }
        ...
        public static string New(CredentialOptions credentialsOptions, string filename, string records, NewOptions newOptions = null,
            XML_FORMAT xmlFormat = XML_FORMAT.XML, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.New(credentialsOptions, filename, records, newOptions, DATAFORMAT_TYPE.XML, (DATAFORMATCRU_TYPE)xmlFormat, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.Delete(credentialsOptions, filename, records, deleteOptions, DATAFORMAT_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        XML_FORMAT xmlFormat = XML_FORMAT.XML, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Select(credentialsOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, (DATAFORMATCRU_TYPE)xmlFormat, customVars, receiveTimeout);
        }
        ...
        string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Subroutine(credentialsOptions, subroutineName, argsNumber, arguments, DATAFORMAT_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        /// <param name="receiveTimeout">It's the maximum time in seconds that the client will keep waiting the answer by the server. By default 0 (wait indefinitely).</param>
        /// <returns>The results of the operation.</returns>
        public static string Conversion(CredentialOptions credentialsOptions, CONVERSION_TYPE conversionOptions, string expression, string code,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Conversion(credentialsOptions, expression, code, conversionOptions, DATAFORMAT_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        public static string Format(CredentialOptions credentialsOptions, string expression, string formatSpec,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Format(credentialsOptions, expression, formatSpec, DATAFORMAT_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        public static string Dictionaries(CredentialOptions credentialsOptions, string filename,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Dictionaries(credentialsOptions, filename, DATAFORMAT_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        public static string Execute(CredentialOptions credentialsOptions, string statement,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.Execute(credentialsOptions, statement, DATAFORMAT_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.GetVersion(credentialsOptions, DATAFORMAT_TYPE.XML, receiveTimeout);
        }
        ...
        public static string LkSchemas(CredentialOptions credentialsOptions, LkSchemasOptions lkSchemasOptions = null,
             string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.LkSchemas(credentialsOptions, lkSchemasOptions, DATAFORMATSCH_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        public static string LkProperties(CredentialOptions credentialsOptions, string filename, LkPropertiesOptions lkPropertiesOptions = null,
            string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.LkProperties(credentialsOptions, filename, lkPropertiesOptions, DATAFORMATSCH_TYPE.XML, customVars, receiveTimeout);
        }
        ...
        {
            return DirectFunctions.ResetCommonBlocks(credentialsOptions, DATAFORMAT_TYPE.XML, receiveTimeout);
        }
    }
