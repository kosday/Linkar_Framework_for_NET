...
{
    /// <summary>
    /// Linkar.Functions.Direct.XML library namespace.
    /// </summary>
    ...
    public static partial class Functions
    {
        ...
        /// <param name="records">A list of item IDs to read.
        ...
        {
            return DirectFunctions.Read(credentialOptions, filename, records, dictionaries, readOptions, DATAFORMAT_TYPE.XML, (DATAFORMATCRU_TYPE)xmlFormat, customVars, receiveTimeout);
        }
        ...
        /// <summary>
        /// Update one or more attributes of one or more file records, synchronously only, with XML input and output format.
        /// </summary>
        /// <param name="credentialOptions">Object with data necessary to access the Linkar Server: Username, Password, EntryPoint, Language, FreeText.</param>
        /// <param name="filename">Name of the file being updated.</param>
        /// <param name="records">Buffer of record data to update. Inside this string are the recordIds, the modified records, and the originalRecords.</param>
        ...
        /// The record will have to be read, modified and saved again.
        /// </remarks>
        public static string UpdatePartial(CredentialOptions credentialOptions, string filename, string records, UpdateOptions updateOptions = null,
            XML_FORMAT xmlFormat = XML_FORMAT.XML, string customVars = "", int receiveTimeout = 0)
        {
            return DirectFunctions.UpdatePartial(credentialOptions, filename, records, "", updateOptions, DATAFORMAT_TYPE.XML, (DATAFORMATCRU_TYPE)xmlFormat, customVars, receiveTimeout);
        }
        ...
        /// </code>
        /// </example>
        public static string LkProperties(CredentialOptions credentialOptions, string filename, LkPropertiesOptions lkPropertiesOptions = null, XML_FORMAT outputFormat = XML_FORMAT.XML,
            string customVars = "", int receiveTimeout = 0)
        {
